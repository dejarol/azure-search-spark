package io.github.jarol.azure.search.spark.sql.connector.read.config

import com.azure.search.documents.models.{QueryType, SearchMode, SearchOptions}
import io.github.jarol.azure.search.spark.sql.connector.read.SearchOptionsOperations._
import io.github.jarol.azure.search.spark.sql.connector.core.config.{ExtendableConfig, SearchConfig}
import io.github.jarol.azure.search.spark.sql.connector.core.utils.Enums
import io.github.jarol.azure.search.spark.sql.connector.read.SearchOptionsBuilder
