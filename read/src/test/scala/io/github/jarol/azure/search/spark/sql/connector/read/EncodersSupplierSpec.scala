...
import io.github.jarol.azure.search.spark.sql.connector.core.schema.conversion.SchemaViolation.Type
import io.github.jarol.azure.search.spark.sql.connector.core.schema.conversion.{SafeCodecSupplierSpec, SchemaViolationsMixins}
