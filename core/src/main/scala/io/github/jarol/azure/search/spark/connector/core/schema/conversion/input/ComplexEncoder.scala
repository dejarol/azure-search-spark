package io.github.jarol.azure.search.spark.connector.core.schema.conversion.input

import io.github.jarol.azure.search.spark.connector.core.schema.conversion.SearchIndexColumn
