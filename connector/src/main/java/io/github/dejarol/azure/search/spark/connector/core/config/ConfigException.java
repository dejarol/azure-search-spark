...
public class ConfigException
   ...
   public static @NotNull ConfigException forIllegalOptionValue(
    ...
    /**
     * Create an instance for an option with an illegal value, usually generated by a configuration
     * whose raw value could not be converted to a different target type
     * @param key configuration key
