...
class SearchFieldMetadataSpec
  ...
  private lazy val emptyOptions = SearchFieldMetadata.empty()
  ...
  private def assertBehaviorOfGeneratedAction[A](
                                                  value: A,
                                                  copyFunction: (SearchFieldMetadata, A) => SearchFieldMetadata
                                                )(
  ...
  describe(anInstanceOf[SearchFieldMetadata]) {
    describe(SHOULD) {
