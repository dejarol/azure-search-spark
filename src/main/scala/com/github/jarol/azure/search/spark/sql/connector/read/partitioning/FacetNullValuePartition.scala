...
case class FacetNullValuePartition(override protected val inputFilter: Option[String],
  ...
  extends AbstractFacetPartition(facetValues.size, inputFilter, maybeSelect, facetFieldName) {
