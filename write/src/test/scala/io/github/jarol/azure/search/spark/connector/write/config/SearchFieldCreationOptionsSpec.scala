...
import io.github.jarol.azure.search.spark.connector.core.{BasicSpec, FieldFactory, JavaScalaConverters, JsonMixIns}
import io.github.jarol.azure.search.spark.connector.core.config.SearchConfig
import io.github.jarol.azure.search.spark.connector.core.schema.SearchFieldFeature
