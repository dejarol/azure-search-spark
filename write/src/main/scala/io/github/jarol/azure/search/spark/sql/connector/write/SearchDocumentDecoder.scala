...
import io.github.jarol.azure.search.spark.sql.connector.core.schema.conversion.output.SearchDecoder
import io.github.jarol.azure.search.spark.sql.connector.core.schema.conversion.{SchemaViolationException, SearchIndexColumn}
